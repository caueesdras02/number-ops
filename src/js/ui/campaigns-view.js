...
/** Badge/gatilho da etapa — botão interativo (abre o popover customizado, ver
 * ui/stage-dropdown.js) quando ACTIVE e canEdit; span estático quando CLOSED ou VIEWER —
 * continua visível ("bater o olho" na etapa), só não fica editável (inclusive por teclado). */
...
export function renderCampaignDetail({ item, clients, squads, responsibles = [], numbers, locations = [], links, allLinks = links, canEdit = true }) {
